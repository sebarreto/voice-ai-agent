...
def normalize_text(text: str) -> str:
    text = text.lower()
    for k, v in {"ovum": "oven", "tekka": "teka", "dekha": "teka", "tika": "teka"}.items():
...
async def process_with_rag(text: str, conversation: list) -> str:
    ...
    if needs_rag(text):
        ...
        prompt = f"""You are a kitchen assistant.
...
{text}"""
    ...
    messages = [{
        ...
        "content": (
            ...
            "Answer in English. Use manual data when relevant, otherwise use cooking knowledge. "
        ...
        while True:
            try:
                ...
                if text == "__wake__":
                    ...
                    response_text = await process_with_rag(text, conversation)
